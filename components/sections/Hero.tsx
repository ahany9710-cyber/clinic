      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8 lg:py-24">
        <FadeIn className="order-2 lg:order-1">
          ...
          <p className="mt-6 max-w-lg text-base leading-relaxed text-muted md:text-lg">
            أكثر من 25 عاماً من الخبرة في الجلدية والطب التجميلي والليزر — في
            قلب الرياض والقاهرة. نقدّم لكِ رعاية طبية فاخرة ونتائج تُبرز جمالك
            الطبيعي.
          </p>
        ...
        <FadeIn delay={0.2} className="order-1 lg:order-2">
          <div className="relative mx-auto max-w-md lg:max-w-none">
            ...
            <div className="relative overflow-hidden rounded-[2rem] card-shadow">
              <Image
                src={IMAGES.doctor}
                alt="د. شيرين منصور مختار — استشارية الجلدية والتجميل والليزر"
                width={640}
                height={800}
                priority
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-charcoal/70 to-transparent p-6 pt-20">
                ...
                <p className="mt-1 text-sm text-white/80">
                  Consultant Dermatology, Aesthetics & Laser
                </p>
              </div>
            </div>
          </div>
