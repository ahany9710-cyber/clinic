  ...
  return (
    <Section id="locations" background="beige">
      <FadeIn>
        <SectionHeading
          eyebrow="فروعنا"
          title="Aspects Clinica — الرياض والقاهرة"
          subtitle="مركز طبي تجميلي متكامل يقدّم الجلدية، التجميل، الليزر، التغذية، والجراحة — في موقعين استراتيجيين."
        />
      </FadeIn>
      ...
      <StaggerContainer className="grid gap-8 md:grid-cols-2">
        {LOCATIONS.map((location) => (
          <StaggerItem key={location.city}>
            <article className="overflow-hidden rounded-3xl bg-white card-shadow transition-all duration-300 hover:card-shadow-hover">
