...
const whatsappText = (regionLabel: string) =>
  encodeURIComponent(
    `مرحباً، أود حجز استشارة مع الدكتورة شيرين منصور مختار — ${regionLabel}.`
  );
...
const HERO_SUBTITLE =
  "أكثر من 25 عاماً من الخبرة في الجلدية والطب التجميلي والليزر في الرياض بالمملكة العربية السعودية ومصر. نقدّم لكِ رعاية طبية فاخرة ونتائج طبيعية بثقة عالمية.";
...
export const REGIONS: Record<RegionId, RegionConfig> = {
  eg: {
    ...
    aboutParagraphs: [
      ...
      "تعمل استشارية للجلدية التجميل والليزر بالتجمع، القاهرة الجديدة، منذ 2019. حاصلة على شهادات متقدمة في خيوط EPLINE (المستوى الثاني — جدة)، ومنتدى خبراء البوتوكس من Allergan بالمملكة المتحدة، وحضور مؤتمرات IMCAS وEADV العالمية.",
    ],
    credentials: [
      "استشارية الجلدية التجميل والليزر — التجمع، القاهرة الجديدة",
    ...
    bookingBranchLabel: "التجمع، القاهرة الجديدة",
    footerLocation: "التجمع، القاهرة الجديدة · مصر",
    navbarTitle: "د. شيرين منصور مختار",
    metadata: {
      title: "د. شيرين منصور مختار | استشارية الجلدية والتجميل والليزر في مصر",
      description:
        "استشارية الجلدية والتجميل والليزر في مصر — التجمع، القاهرة الجديدة. خيوط EPLINE، بوتوكس Allergan، فيلر، سكين بوستر، ومحفزات الكولاجين. أكثر من 25 عاماً خبرة.",
      locale: "ar_EG",
    },
  },
  sa: {
    ...
    metadata: {
      ...
      description:
        "نائب الجلدية والتجميل بالرياض. خيوط EPLINE، بوتوكس Allergan، فيلر، سكين بوستر، ومحفزات الكولاجين. أكثر من 25 عاماً خبرة.",
      locale: "ar_SA",
    },
  },
};
