...
export const REGIONS: Record<RegionId, RegionConfig> = {
  eg: {
    ...
    titleShort: "استشارية الجلدية والتجميل والليزر",
    heroBadge: "استشارية الجلدية والتجميل والليزر",
    heroSubtitle:
    ...
    aboutSubtitle:
      "استشارية الجلدية والطب التجميلي والليزر — تجمع بين الخبرة السريرية العميقة والتدريب الدولي المتقدم.",
    aboutParagraphs: [
    ...
    metadata: {
      title: "د. شيرين منصور مختار | استشارية الجلدية والتجميل — Aspects Clinica مصر",
      description:
        "استشارية الجلدية والطب التجميلي والليزر — Aspects Clinica بالتجمع، القاهرة الجديدة. حقن الفيلر، البوتوكس، السكين بوستر، ومحفزات الكولاجين.",
      locale: "ar_EG",
    },
  },
  sa: {
    ...
    title: "نائبة الجلدية والتجميل والليزر — الرياض، المملكة العربية السعودية",
    titleShort: "نائبة الجلدية والتجميل والليزر",
    heroBadge:
      "نائبة الجلدية والتجميل والليزر — الرياض، المملكة العربية السعودية",
    heroSubtitle:
    ...
    aboutSubtitle:
      "نائبة الجلدية والتجميل والليزر في الرياض — تجمع بين الخبرة السريرية العميقة والتدريب الدولي المتقدم.",
    aboutParagraphs: [
      ...
      "تعمل نائبة للجلدية والتجميل والليزر في Aspects Clinica بالرياض، المملكة العربية السعودية، حيث تقدّم رعاية تجميلية فاخرة ونتائج طبيعية بثقة عالمية.",
    ],
    credentials: [
      "نائبة الجلدية والتجميل والليزر — الرياض، المملكة العربية السعودية",
      "خريجة جامعة عين شمس",
    ...
    metadata: {
      title: "د. شيرين منصور مختار | نائبة الجلدية والتجميل — Aspects Clinica الرياض",
      description:
        "نائبة الجلدية والتجميل والليزر في الرياض — Aspects Clinica. حقن الفيلر، البوتوكس، السكين بوستر، ومحفزات الكولاجين.",
      locale: "ar_SA",
    },
  },
};
