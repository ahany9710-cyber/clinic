...
export const REGIONS: Record<RegionId, RegionConfig> = {
  ...
  sa: {
    ...
    aboutParagraphs: [
      "الدكتورة شيرين منصور مختار خريجة كلية الطب بجامعة عين شمس، وحاصلة على ماجستير الجلدية والتناسلية عام 2011. عملت نائبة جلدية في مستشفى الإيمان بالرياض لأكثر من 9 سنوات (2007–2016).",
    ...
    credentials: [
      ...
      "نائبة جلدية سابقة — مستشفى الإيمان، الرياض (9 سنوات)",
      "ماجستير الجلدية والتناسلية — جامعة عين شمس",
      "المستوى الثاني — خيوط EPLINE — جدة 2019",
      "أكثر من 25 عاماً من الخبرة السريرية",
    ],
